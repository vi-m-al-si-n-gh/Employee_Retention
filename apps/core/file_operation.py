...
import pickle #used for serializing (saving) and deserializing (loading) Python objects. It allows you to store complex objects (like machine learning models
import os #provides functions to interact with the operating system, such as handling files, directories, and system paths.
import shutil #copying and deleting directories.
